        ...
        <Stack padding={[4, 4, 12, 12]} backgroundColor={'yellow.personal'}>
          <Stack>
            <Stack isInline spacing={8} justifyContent={'center'} width={'100%'}>
              <Image src={myBook?.volumeInfo?.imageLinks.thumbnail} height="200px" width="170px" shadow={'2xl'}/>
              <Stack spacing={2}>
            ...
            >
              ...
              <Stack spacing={2} isInline>
                ...
                <IconButton variant={isLiked ? 'solid' : 'outline'} aria-label="icon" borderRadius={'50%'} colorScheme={'pink'}
                            onClick={handleUpdateLike} icon={<Box as={BiHeart}/>} size="md"/>
              </Stack>
            </Stack>
          </Stack>
        </Stack>
